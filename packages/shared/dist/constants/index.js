...
exports.APP_CONFIG = exports.HTTP_STATUS = exports.SUCCESS_MESSAGES = exports.ERROR_CODES = exports.VALIDATION_RULES = exports.PAGINATION = exports.MEDIA_CONSTRAINTS = exports.STORAGE_KEYS = exports.API_ENDPOINTS = void 0;
exports.API_ENDPOINTS = {
    ...
    PLAYERS: {
        CREATE: '/api/players',
        GET_BY_ID: (id) => `/api/players/${id}`,
        SEARCH: '/api/players/search',
        UPDATE: (id) => `/api/players/${id}`,
    },
    // Media
    MEDIA: {
        UPLOAD: '/api/media/upload',
        GET_BY_ID: (id) => `/api/media/${id}`,
